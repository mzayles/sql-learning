...
INSERT INTO Cliente(idCliente, nome, email) VALUES (800, "Luciana", "luciana@email.com");

INSERT INTO Produto(idProduto, idCliente, nome, quantidade) VALUES 
	(160, 800, "Detergente Ypê", 2),
    (170, 800, "Papel Higiênico Fofinho", 1);

UPDATE Produto SET nome = "Caixa Bombom Sonho de Valsa" WHERE idProduto = 50;

DELETE FROM Produto WHERE idCliente = 300 AND idProduto = 20;

SELECT * FROM Produto WHERE quantidade >= 10;

SELECT c.nome, p.nome, p.quantidade
FROM Produto AS p
